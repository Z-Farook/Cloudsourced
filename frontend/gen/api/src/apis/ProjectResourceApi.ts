...
export class ProjectResourceApi extends runtime.BaseAPI {
   ...
   * add
   */
  async addUsingPOSTRaw(
    requestParameters: AddUsingPOSTRequest
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "projectDTO",
        "Required parameter requestParameters.projectDTO was null or undefined when calling addUsingPOST."
      );
    }
