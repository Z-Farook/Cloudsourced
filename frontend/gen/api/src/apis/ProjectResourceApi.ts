...
export class ProjectResourceApi extends runtime.BaseAPI {
     ...
     * addWithUser
     */
    async addWithUserUsingPOSTRaw(requestParameters: AddWithUserUsingPOSTRequest): Promise<runtime.ApiResponse<Project>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling addWithUserUsingPOST.');
        }

        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling addWithUserUsingPOST.');
        }
     ...
     * addWithUser
     */
    async addWithUserUsingPOST(requestParameters: AddWithUserUsingPOSTRequest): Promise<Project> {
     ...
     * createNew
     */
    async createNewUsingPOST1Raw(requestParameters: CreateNewUsingPOST1Request): Promise<runtime.ApiResponse<Project>> {
     ...
     * createNew
     */
    async createNewUsingPOST1(requestParameters: CreateNewUsingPOST1Request): Promise<Project> {
     ...
     * getOneById
     */
    async getOneByIdUsingGET1Raw(requestParameters: GetOneByIdUsingGET1Request): Promise<runtime.ApiResponse<ProjectDTO>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * getOneById
     */
    async getOneByIdUsingGET1(requestParameters: GetOneByIdUsingGET1Request): Promise<ProjectDTO> {
