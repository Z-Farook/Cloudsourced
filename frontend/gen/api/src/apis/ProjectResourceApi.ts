...
export class ProjectResourceApi extends runtime.BaseAPI {
  ...
  async createNewUsingPOST2Raw(
    ...
    if (
      requestParameters.projectDTO === null ||
      requestParameters.projectDTO === undefined
    ) {
      throw new runtime.RequiredError(
        "projectDTO",
        "Required parameter requestParameters.projectDTO was null or undefined when calling createNewUsingPOST2."
      );
    }
   ...
   * finishProject
   */
  async finishProjectUsingPOSTRaw(
    requestParameters: FinishProjectUsingPOSTRequest
  ): Promise<runtime.ApiResponse<ProjectDetailDTO>> {
    if (
      ...
      throw new runtime.RequiredError(
        "projectId",
        "Required parameter requestParameters.projectId was null or undefined when calling finishProjectUsingPOST."
      );
    }
    ...
    const response = await this.request({
      path: `/project/finish/{projectId}`.replace(
        `{${"projectId"}}`,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProjectDetailDTOFromJSON(jsonValue)
    );
  }
   ...
   */
  async getProjectDetailByIdUsingGETRaw(
    requestParameters: GetProjectDetailByIdUsingGETRequest
  ): Promise<runtime.ApiResponse<ProjectDetailDTO>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling getProjectDetailByIdUsingGET."
      );
    }
    ...
    const response = await this.request({
      path: `/project/detail/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(requestParameters.id))
      ),
      method: "GET",
   ...
   * getProjectDetailById
   */
  async getProjectDetailByIdUsingGET(
    requestParameters: GetProjectDetailByIdUsingGETRequest
  ): Promise<ProjectDetailDTO> {
    const response = await this.getProjectDetailByIdUsingGETRaw(
      requestParameters
    );
    return await response.value();
  }
   ...
   * getProjectsByUserId
   */
  async getProjectsByUserIdUsingGETRaw(
    requestParameters: GetProjectsByUserIdUsingGETRequest
  ): Promise<runtime.ApiResponse<Array<ProjectDTO>>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling getProjectsByUserIdUsingGET."
      );
    }
    ...
    const response = await this.request({
      path: `/project/profile/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(requestParameters.id))
      ),
      method: "GET",
   ...
   * getProjectsByUserId
   */
  async getProjectsByUserIdUsingGET(
    requestParameters: GetProjectsByUserIdUsingGETRequest
  ): Promise<Array<ProjectDTO>> {
    const response = await this.getProjectsByUserIdUsingGETRaw(
      requestParameters
    );
    return await response.value();
  }
   ...
   * getProjectsByUser
   */
  async getProjectsByUserUsingGETRaw(): Promise<
    runtime.ApiResponse<Array<ProjectDTO>>
  > {
    const queryParameters: runtime.HTTPQuery = {};
   ...
   * update
   */
  async updateUsingPUT2Raw(
    requestParameters: UpdateUsingPUT2Request
  ): Promise<runtime.ApiResponse<ProjectDTO>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling updateUsingPUT2."
      );
    }
    ...
    if (requestParameters.dto === null || requestParameters.dto === undefined) {
      throw new runtime.RequiredError(
        "dto",
        "Required parameter requestParameters.dto was null or undefined when calling updateUsingPUT2."
      );
    }
