...
export class AuthenticationResourceApi extends runtime.BaseAPI {
   ...
   * registerNewUser
   */
  async registerNewUserUsingPOSTRaw(
    requestParameters: RegisterNewUserUsingPOSTRequest
  ): Promise<runtime.ApiResponse<User>> {
    if (
      requestParameters.registerUserDTO === null ||
      requestParameters.registerUserDTO === undefined
    ) {
      throw new runtime.RequiredError(
        "registerUserDTO",
        "Required parameter requestParameters.registerUserDTO was null or undefined when calling registerNewUserUsingPOST."
      );
    }
   ...
   * registerNewUser
   */
  async registerNewUserUsingPOST(
    requestParameters: RegisterNewUserUsingPOSTRequest
  ): Promise<User> {
