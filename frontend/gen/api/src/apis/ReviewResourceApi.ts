...
export class ReviewResourceApi extends runtime.BaseAPI {
     ...
     * createNew
     */
    async createNewUsingPOST3Raw(requestParameters: CreateNewUsingPOST3Request): Promise<runtime.ApiResponse<Review>> {
     ...
     * createNew
     */
    async createNewUsingPOST3(requestParameters: CreateNewUsingPOST3Request): Promise<Review> {
