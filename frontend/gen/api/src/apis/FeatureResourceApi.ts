...
export class FeatureResourceApi extends runtime.BaseAPI {
     ...
     * createNew
     */
    async createNewUsingPOSTRaw(requestParameters: CreateNewUsingPOSTRequest): Promise<runtime.ApiResponse<Feature>> {
        if (requestParameters.entity === null || requestParameters.entity === undefined) {
            throw new runtime.RequiredError('entity','Required parameter requestParameters.entity was null or undefined when calling createNewUsingPOST.');
        }
     ...
     * createNew
     */
    async createNewUsingPOST(requestParameters: CreateNewUsingPOSTRequest): Promise<Feature> {
